    ...
    .addUserOption(option => option
     ...
     async execute(interaction) {
        ...
        let kills = [
            ...
            `${perp} created an alternate timeline, attempted to travel back to the previous timeline, lost their partner to an evil-twisted version of themselves from the future, and made their time remnant suffer so that they would become their evil-variant in the past, sealing their doomed fate eternally.`,
            ...
            `${perp} publicly shamed ${target}, causing the crowd to beat ${target} to death.`,
            ...
            `${target} got fried by the Gamma-Rays emitted from the Infinity Stones.`,
            `${perp} got fried by the Gamma-Rays emitted from the Infinity Stones.`,
            ...
            `${target} stopped the JFK assasination, 9/11, Pearl Harbour, and the Lincon Assasination, causing them to be erased from existence.`,
            `${perp} was crushed alive by a Garbage Truck's compactor.`,
