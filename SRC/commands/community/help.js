...
module.exports = {
    ...
    .setDescription('Troubleshoot any of your problems here!'),
     async execute(interaction) {
        ...
        .addFields({ name: "``/help``", value: "Solve your problems or troubleshoot your dilema"})
        ...
        .setDescription("**Commands List P3**")
         ...
         .addFields({ name: "``/hack``", value: "Hacks a user! 100% unsafe guarantied!"})
         ...
         .addFields({ name: "``/tictoe``", value: "1v1 someone at TicTacToe!"})
        ...
        .setColor('Blue')
        .setDescription('**FAQ**')
        .addFields({ name: "``null``", value: "null"})
        .addFields({ name: "``Will you ever have a premium system?``", value: "No, NEVER! This bot will remain 100% free- Forever. That's a promise!"})
        .addFields({ name: "``Is the bot open-source?``", value: "Yes! You can obtain the link to the sourcecode on page 4!"})
        ...
        .addFields({ name: "``BL4IR is offline!?!? Why?``", value: "This may be because the bot has either; crashed, brought offline by the host, or being updated."})

        const helpembedpage3 = new EmbedBuilder()
        .setColor("Blue")
        .setDescription("**Credits**")
        .addFields({ name: "Developer:", value: "Archangel (@archangelthegod)"})
        .addFields({ name: "Top contributer:", value: "Evancommitsmeme, Shadow223"})
        .addFields({ name: "Hosting Service:", value: "Daki.cc"})
        .addFields({ name: " ", value: " "})
        .addFields({ name: "Special Thanks to:", value: "Shadow223 (@.shadow223), DreadKnought, Evancommitsmeme "})
        .addFields({ name: "Early Supporters:", value: "Shadow223, Evancommitsmeme, Maryonacross, Astreem"})
